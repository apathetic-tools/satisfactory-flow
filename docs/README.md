# SatFlow Documentation

This directory contains Jekyll-based documentation for the SatFlow project.
...
The documentation will be available at `http://localhost:4000/satflow/`
...
cd docs
bundle install
bundle exec jekyll serve --baseurl /satflow
```
