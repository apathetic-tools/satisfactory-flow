...
Thanks for your interest in contributing to **SatFlow** — a tool to stitch your module into a single file.  
...
SatFlow ships two forms:

| Target | Command | Output |
|---------|----------|--------|
| **Single-file script** | `poetry run poe build:stitched` | Creates `dist/satflow.py` |
...
**Thank you for helping keep satflow tiny, dependency-free, and delightful.**
